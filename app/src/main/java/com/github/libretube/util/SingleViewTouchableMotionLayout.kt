...
class SingleViewTouchableMotionLayout(context: Context, attributeSet: AttributeSet? = null) : MotionLayout(context, attributeSet) {
    ...
    private val viewsToDetectTouch by lazy {
        arrayOf(findViewById<View>(R.id.main_container), findViewById(R.id.constraintLayout10)) // TODO move to Attributes
    }
