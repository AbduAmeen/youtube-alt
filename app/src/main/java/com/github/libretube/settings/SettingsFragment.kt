...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val instance = findPreference<ListPreference>(getString(R.string.preference_instance))
        fetchInstance()
        // TODO: add dependecy injection and viewmodel

//        instance?.setOnPreferenceChangeListener { _, newValue ->
//            RetrofitClient.url = newValue.toString()
//            RetrofitClient.lazyMgr.reset()
...
//        }
    ...
    private fun fetchInstance() {
        lifecycleScope.launchWhenCreated {
            val response = try {
                // RetrofitClient.api.getInstances("https://instances.tokhmi.xyz/")
            } catch (e: IOException) {
                println(e)
